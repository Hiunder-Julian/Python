...
// Obtener datos de la tabla Juego
$sql = "SELECT id, Nombre, imagen FROM Juego";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['agregar_juego'])) {
        ...
        if ($nuevo_imagen['error'] == 0) {
            ...
            $sql = "INSERT INTO Juego (Nombre, imagen) VALUES (?, ?)";
        ...
        $sql = "UPDATE Juego SET Nombre=?, imagen=? WHERE id=?";
        $stmt = $conn->prepare($sql);
...
<head>
    <meta charset="UTF-8">
    <title>Administración de Juego</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <a href="admin2.php">
            <button type="button">Juego2</button>
        </a>
    </header>
        ...
        <?php foreach ($juegos as $juego): ?>
            <li>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="imagen_actual" value="<?php echo $juego['imagen']; ?>">
                    ...
                    <img src="<?php echo $juego['imagen']; ?>" alt="Imagen actual">
    ...
    <div id="nuevoJuegoForm" style="display:none;">
        ...
        <label>Nombre:</label>
            ...
            <button type="submit" name="agregar_juego">Agregar Juego</button>
